...
/* touch managers by YellowAfterlife */

function touchControl(inner, outer, x, y) {
	this.inner = inner;
	this.outer = outer;
	this.pos_x = x;
	this.pos_y = y;
...
touchControl.prototype = {
	clear: function() {
		this.x = this.y = this.c = 0;
		this.down = this.pressed = this.released = false;
	},
	getDisplayX: function() {
		return this.pos_x < 0 ? room_viewport_width + this.pos_x : this.pos_x;
	},
	getDisplayY: function() {
		return this.pos_y < 0 ? room_viewport_height + this.pos_y : this.pos_y;
	},
	update: function() {
		var lx = this.getDisplayX(), ly = this.getDisplayY(), x, y, c, i, dx, dy, dl;
		c = this.c;
		this.clear();
		for (i = 0; i < touch_count; i++) {
			dx = (touch_x[i] - lx);
			dy = (touch_y[i] - ly);
			if ((dl = dx * dx + dy * dy) < this.outer * this.outer) {
				dl = max(sqrt(dl), this.inner);
				dx /= dl; dy /= dl;
				this.x += dx;
				this.y += dy;
				this.c++;
		...
		this.down = this.c != 0;
		this.pressed = this.down && c == 0;
		this.released = !this.down && c != 0;
		if (this.down) {
			this.x /= this.c;
			this.y /= this.c;
		}
	...
	draw: function() {
		var lx = this.getDisplayX(), ly = this.getDisplayY(), c = tu_draw_color;
		draw_set_color(255, 255, 255); draw_set_alpha(0.5);
		draw_circle(lx, ly, this.outer, true);
		draw_circle(lx, ly, this.inner, false);
		draw_circle(lx + this.x * this.inner, ly + this.y * this.inner, 20, false);
		draw_set_alpha(1);
	}
}
//
function touch_create(inner, outer, x, y) { return new touchControl(inner, outer, x, y) }
function touch_update() { var i, l = arguments.length; for (i = 0; i < l; i++) arguments[i].update() }
function touch_draw() { var i, l = arguments.length; for (i = 0; i < l; i++) arguments[i].draw() }
function touch_get_x(o) { return o.x }
function touch_get_y(o) { return o.y }
function touch_check(o) { return o.down }
function touch_check_pressed(o) { return o.pressed }
function touch_check_released(o) { return o.released }
...
__sprite_init__(this, spr_player, 20, 20, 10, 10, 'Circle', 10, 0, 20, 0, 20, ['img/spr_player_0.png']);
}; var spr_player = new __spr_player();

function __sprite_5() { 
__sprite_init__(this, sprite_5, 20, 20, 10, 10, 'Box', 10, 0, 20, 0, 20, ['img/sprite_5_0.png']);
}; var sprite_5 = new __sprite_5();

function __sprite_54() { 
__sprite_init__(this, sprite_54, 20, 20, 10, 10, 'Box', 10, 0, 20, 0, 20, ['img/sprite_54_0.png']);
}; var sprite_54 = new __sprite_54();

function __btn_s_01() { 
__sprite_init__(this, btn_s_01, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/btn_s_01_0.png']);
}; var btn_s_01 = new __btn_s_01();

function __btn_s_02() { 
__sprite_init__(this, btn_s_02, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/btn_s_02_0.png']);
}; var btn_s_02 = new __btn_s_02();

function __btn_s_03() { 
__sprite_init__(this, btn_s_03, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/btn_s_03_0.png']);
}; var btn_s_03 = new __btn_s_03();
...
with(this) {
this.other = this.place_meeting(this.x, this.y, object_box_01);
if(this.other != null) {
x = xprevious;
y = yprevious;
}
this.other = this.place_meeting(this.x, this.y, object_box_02);
if(this.other != null) {
onDeviceReady();
...
draw_self();
	...
	draw_sprite(btn_s_03,btn_s_03,room_viewport_x + 240,room_viewport_y + 380);
}
}
};
}; var obj_player = new __obj_player();

function __object_box_01() {
__instance_init__(this, object_box_01, null, 1, 0, sprite_5, 1, 2);
...
}; var object_box_01 = new __object_box_01();

function __object_box_02() {
__instance_init__(this, object_box_02, null, 1, 0, sprite_54, 1, 48);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.objects = [
[{o:obj_player, x:160, y:140}],
[{o:object_box_01, x:10, y:10}],
[{o:object_box_01, x:10, y:30}],
[{o:object_box_01, x:10, y:50}],
[{o:object_box_01, x:30, y:10}],
[{o:object_box_01, x:50, y:10}],
[{o:object_box_01, x:10, y:70}],
[{o:object_box_01, x:10, y:90}],
[{o:object_box_01, x:70, y:10}],
[{o:object_box_01, x:90, y:10}],
[{o:object_box_01, x:310, y:310}],
[{o:object_box_01, x:310, y:290}],
[{o:object_box_01, x:290, y:310}],
[{o:object_box_01, x:10, y:310}],
[{o:object_box_01, x:310, y:10}],
[{o:object_box_01, x:290, y:10}],
[{o:object_box_01, x:310, y:30}],
[{o:object_box_01, x:10, y:290}],
[{o:object_box_01, x:30, y:310}],
[{o:object_box_01, x:10, y:270}],
[{o:object_box_01, x:50, y:310}],
[{o:object_box_01, x:10, y:250}],
[{o:object_box_01, x:70, y:310}],
[{o:object_box_01, x:10, y:230}],
[{o:object_box_01, x:90, y:310}],
[{o:object_box_01, x:270, y:310}],
[{o:object_box_01, x:310, y:270}],
[{o:object_box_01, x:290, y:290}],
[{o:object_box_01, x:310, y:250}],
[{o:object_box_01, x:310, y:230}],
[{o:object_box_01, x:310, y:210}],
[{o:object_box_01, x:310, y:50}],
[{o:object_box_01, x:270, y:10}],
[{o:object_box_01, x:250, y:10}],
[{o:object_box_01, x:230, y:10}],
[{o:object_box_01, x:210, y:10}],
[{o:object_box_01, x:190, y:10}],
[{o:object_box_01, x:170, y:10}],
[{o:object_box_01, x:110, y:10}],
[{o:object_box_01, x:30, y:30}],
[{o:object_box_01, x:10, y:110}],
[{o:object_box_01, x:10, y:210}],
[{o:object_box_01, x:10, y:130}],
[{o:object_box_01, x:130, y:10}],
[{o:object_box_01, x:150, y:10}],
[{o:object_box_01, x:310, y:70}],
[{o:object_box_01, x:10, y:150}],
[{o:object_box_01, x:10, y:190}],
[{o:object_box_01, x:310, y:90}],
[{o:object_box_01, x:110, y:310}],
[{o:object_box_01, x:250, y:310}],
[{o:object_box_01, x:230, y:310}],
[{o:object_box_02, x:30, y:290}],
[{o:object_box_02, x:30, y:140}],
[{o:object_box_02, x:160, y:30}],
[{o:object_box_02, x:310, y:150}],
[{o:object_box_02, x:310, y:130}],
[{o:object_box_02, x:310, y:110}],
[{o:object_box_02, x:310, y:170}],
[{o:object_box_02, x:310, y:190}],
[{o:object_box_02, x:210, y:310}],
[{o:object_box_02, x:130, y:310}],
